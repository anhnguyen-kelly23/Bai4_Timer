...
//	reg [31:0] sec_reg, min_reg, hour_reg;
//	
...
//      end
//	end
//   decoder dec0 ( .idata(sec_reg[3:0]),  .odata(oHex0) );
//   decoder dec1 ( .idata(sec_reg[7:4]),  .odata(oHex1) );
//   decoder dec2 ( .idata(min_reg[3:0]),  .odata(oHex2) );
//   decoder dec3 ( .idata(min_reg[7:4]),  .odata(oHex3) );
//   decoder dec4 ( .idata(hour_reg[3:0]), .odata(oHex4) );
//   decoder dec5 ( .idata(hour_reg[7:4]), .odata(oHex5) );
